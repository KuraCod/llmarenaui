            ...
            {items.map((item, index) => (
                <div
                    ...
                    className={cn(
                        ...
                        "border border-border/50 bg-black/40",
                        "hover:shadow-[0_2px_12px_rgba(255,111,53,0.1)]",
                        "hover:-translate-y-0.5 will-change-transform",
                        item.colSpan || "col-span-1",
                        item.colSpan === 2 ? "md:col-span-2" : "",
                        {
                            "shadow-[0_2px_12px_rgba(255,111,53,0.1)] -translate-y-0.5":
                    ...
                    <div className="relative flex flex-col space-y-3">
                        ...
                        <div className="space-y-2">
                            <h3 className="font-medium text-gray-100 tracking-tight text-[15px]">
                                {item.title}
                                <span className="ml-2 text-xs text-gray-400 font-normal font-mono-numbers">
                                    {item.meta}
                                </span>
                            </h3>
